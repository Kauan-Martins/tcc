...
<body>
	<header class="header">
		...
		<a href="area-restrita.php" id="logo"><img src="img/Images_header/logotipo.svg" ></a>
	...
	<div class="container-2">		
		<aside class="aside">
			<ul>
            	...
            	<li><a href="#planos-info">Informações de Planos</a></li>
            	<li><a href="#pagamento-info">Pagamento</a></li>
		...
		<main class="main">
			<section class="banner">
				<h1 class="titulo">Seja bem vindo<br>$nome !</h1>
			</section>
			<section class="conta">
				<header class="titulo">
			...
			<section class="conta">
				<header class="titulo">
					<h1 id="planos-info">Informações de Planos</h1>
				</header>
					<table>
			...
			<section class="conta">
				<header class="titulo">
					<h1 id="pagamento-info">Mensalidade</h1>
				</header>
					<table>
